						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Kolkata ,West Bengal</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+91-9503019259</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>jha.4@iitj.ac.in</a></li>
								</ul>
							</div>
						</div>
